...
var User_CtrlComponent = (function () {
    ...
    User_CtrlComponent.prototype.showUserForm = function (user) {
        this.user_list_show = false;
        this.userForm.showUser(user);
    };
    __decorate([
        core_1.ViewChild(user_form_component_1.User_FormComponent), 
        __metadata('design:type', user_form_component_1.User_FormComponent)
    ], User_CtrlComponent.prototype, "userForm", void 0);
    User_CtrlComponent = __decorate([
        core_1.Component({
            selector: 'user-ctrl',
            template: "<user-list *ngIf=\"user_list_show\" (userPick)=\"showUserForm($event)\"></user-list>\n    <user-form [hidden]=\"user_list_show\" (backToList)=\"showUserList($event)\"></user-form>",
